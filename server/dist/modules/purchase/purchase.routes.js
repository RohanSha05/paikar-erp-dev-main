...
const controller = __importStar(require("./purchase.controller"));
const auth_1 = require("../../common/middleware/auth");
const validate_1 = require("../../common/middleware/validate");
const purchase_validator_1 = require("./purchase.validator");
const router = (0, express_1.Router)();
router.get('/', auth_1.requireAuth, controller.list);
router.get('/:id', auth_1.requireAuth, (0, validate_1.validate)(purchase_validator_1.getPurchaseOrderSchema), controller.getById);
