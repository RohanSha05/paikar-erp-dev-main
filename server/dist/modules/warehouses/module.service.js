...
function createWarehouse(input) {
    return __awaiter(this, void 0, void 0, function* () {
        const existing = yield prisma_1.prisma.warehouse.findUnique({ where: { code: input.code } });
        if (existing) {
...
function updateWarehouse(id, input) {
    return __awaiter(this, void 0, void 0, function* () {
        const warehouse = yield prisma_1.prisma.warehouse.findUnique({ where: { id } });
        if (!warehouse) {
